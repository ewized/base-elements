 ...
 * http://polymer.github.io/PATENTS.txt
 */
const r=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,s=(t,e,n=null,r=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,r),e=n}},i=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}}},function(t,e,n){"use strict";n.d(e,"d",(function(){return o})),n.d(e,"b",(function(){return a})),n.d(e,"c",(function(){return c})),n.d(e,"a",(function(){return l}));var r=n(3),s=n(4);const i=t=>r.c`${Object(r.g)(t[0][1])}`;function o(...t){return e=>{Object.defineProperty(e,"styles",{value:t.map(t=>t instanceof r.a?t:i(t))})}}const a=(t,e="The value was null")=>{if(t)return t;throw new Error(e)},c=Object(s.c)((t,e=!1)=>n=>{((t,e="The value was false")=>{if(!t)throw new Error(e)})(n instanceof s.a,"unsafeHTML can only be used in text bindings");const r=document.createElement("script");r.src=t,r.async=e,n.setValue(r)}),l=(t,e)=>n=>{const r=window.customElements;return r.get(t)||("string"==typeof e?r.define(t,n,{extends:e}):r.define(t,n,e)),n}},function(t,e,n){"use strict";n.d(e,"b",(function(){return s})),n.d(e,"a",(function(){return i}));var r=n(0);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
