 ...
 * http://polymer.github.io/PATENTS.txt
 */
const o=133;function a(t,e){const{element:{content:n},parts:r}=t,s=document.createTreeWalker(n,o,null,!1);let i=l(r),a=r[i],c=-1,u=0;const p=[];let d=null;for(;s.nextNode();){c++;const t=s.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(p.push(t),null===d&&(d=t)),null!==d&&u++;void 0!==a&&a.index===c;)a.index=null!==d?-1:a.index-u,a=r[i=l(r,i)]}p.forEach(t=>t.parentNode.removeChild(t))}const c=t=>{let e=11===t.nodeType?0:1;const n=document.createTreeWalker(t,o,null,!1);for(;n.nextNode();)e++;return e},l=(t,e=-1)=>{for(let n=e+1;n<t.length;n++){const e=t[n];if(Object(i.d)(e))return n}return-1};var u=n(8),p=n(6),d=n(10);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
