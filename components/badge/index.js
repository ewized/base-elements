 ...
 * http://polymer.github.io/PATENTS.txt
 */
const s=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,r=(t,e,n=null,s=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,s),e=n}},i=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}}},function(t,e,n){"use strict";n.d(e,"d",(function(){return o})),n.d(e,"b",(function(){return a})),n.d(e,"c",(function(){return c})),n.d(e,"a",(function(){return u}));var s=n(3),r=n(4);const i=t=>s.c`${Object(s.g)(t[0][1])}`;function o(...t){return e=>{Object.defineProperty(e,"styles",{value:t.map(t=>t instanceof s.a?t:i(t))})}}const a=(t,e="The value was null")=>{if(t)return t;throw new Error(e)},c=Object(r.c)((t,e=!1)=>n=>{((t,e="The value was false")=>{if(!t)throw new Error(e)})(n instanceof r.a,"unsafeHTML can only be used in text bindings");const s=document.createElement("script");s.src=t,s.async=e,n.setValue(s)}),u=(t,e)=>n=>{const s=window.customElements;return s.get(t)||("string"==typeof e?s.define(t,n,{extends:e}):s.define(t,n,e)),n}},function(t,e,n){"use strict";n.d(e,"b",(function(){return r})),n.d(e,"a",(function(){return i}));var s=n(0);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
